...
export default {
  ...
  // cacheDirectory: "/private/var/folders/_v/_80v64y14q7b91swnz5nprrm0000gn/T/jest_dx",
  ...
  // Make calling deprecated APIs throw helpful AppError messages
  // AppErrorOnDeprecated: false,
  ...
  // setupFilesAfterEnv: ['<rootDir>/src/config/db-env.ts'],
